...
urlpatterns = [
    ...
    url(r'^/experiments/history/$', views.admin_experiments_list, name='experiments_history'),
    ...
    url(r'^change/experiment/(?P<pk>\d+)/visibility/$', views.change_experiment_visibility, name='change_experiment_visibility'),
    url(r'^change/experiment/(?P<pk>\d+)/visibility/on/$', views.change_experiment_visibility, name='change_experiment_visibility_on'),
    url(r'^change/experiment/(?P<pk>\d+)/visibility/off/$', views.change_experiment_visibility, name='change_experiment_visibility_off'),
