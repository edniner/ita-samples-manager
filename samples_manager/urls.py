...
urlpatterns = [
    ...
    url(r'^experiment/(?P<experiment_id>\d+)/samples/sample/(?P<sample_id>\d+)/dosimeter/(?P<dosimeter_id>\d+)/assign/$', views.save_samples_dosimeters, name='save_samples_dosimeters'),
